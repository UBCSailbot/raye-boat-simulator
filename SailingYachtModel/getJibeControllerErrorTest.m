...
assert(getJibeControllerErrorRad(pi /100, - pi / 100, pi) == (99/100) * 2 * pi);
assert(getJibeControllerErrorRad(pi /100, - pi / 100, 0) > (-3/100) * pi && getJibeControllerErrorRad(pi /100, - pi / 100, 0) < 0);